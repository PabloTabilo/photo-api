...
async function getPhoto(req, res) {
    const photo = await Photo_1.default.findById(req.params.id); // con await lo transformo en objeto
...
async function deletePhoto(req, res) {
    ...
    if (photo) {
        await fs_extra_1.default.unlink(path_1.default.resolve(photo.imagePath)); // esto toma tiempo
    }
    return res.json({
